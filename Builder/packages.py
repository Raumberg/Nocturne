...
BASE_PACKAGES = [
    ...
    "p7zip", "gparted", "sshfs", "openvpn", "tmux", "xclip", "gpick", "wget", "ueberzug", "netctl", "light", "libreoffice",
    "breeze", "vulkan-intel", "intel-ucode", "ttf-jetbrains-mono", "ttf-jetbrains-mono-nerd", "ttf-fira-code", "neovim", 
    "ttf-iosevka-nerd", "hyprland"
]
...
DEV_PACKAGES = [
    ...
    "telegram-desktop", "youtube-dl", "code", "cowsay",
